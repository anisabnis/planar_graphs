...
class VariableHolder():
    ...
    def getVariable(self, type, name, lb = 0, ub = 1):
        ...
        elif type == 'a' or type == 'b' or type == 'w' or type == 'q' or type == "s" or type == "q" or type == 'm' or type == 'l' or type == 'e' or type == 'x'  or type == 'v' or type =='d': 
            v = binaryVariable(name)
            self.variables[name] = v
            return v

        
        elif type == 'e' or type == 'f' or type == 'o':
